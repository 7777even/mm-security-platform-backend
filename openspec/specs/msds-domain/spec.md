# msds-domain Specification

## Purpose
化学品 MSDS 能力：以只读表 `fac_msds` 承接危化品 MSDS 列表与按 CAS 号详情查询，供移动端 `/msds`、`/msds/:cas` 页面渲染。设计依据见 `openspec/archive/2026-09-16-add-msds-domain/design.md`。
