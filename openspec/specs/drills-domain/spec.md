# drills-domain Specification

## Purpose
应急演练能力：以只读表 `fac_drill` / `fac_drill_task` 承接应急演练列表与详情（含任务子项）查询，供移动端 `/drills`、`/drills/:id` 页面渲染。设计依据见 `openspec/archive/2026-09-16-add-drills-domain/design.md`。
