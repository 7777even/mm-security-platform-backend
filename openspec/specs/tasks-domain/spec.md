# tasks-domain Specification

## Purpose
处置任务能力：以只读表 `fac_dispatch_task` 承接处置任务列表与按 id 详情查询，供移动端 `/tasks`、`/tasks/:id` 页面渲染。设计依据见 `openspec/archive/2026-09-16-add-tasks-domain/design.md`。
