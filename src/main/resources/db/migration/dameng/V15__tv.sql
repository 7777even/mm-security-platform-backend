...
CREATE TABLE fac_tv_stat_item (
    ...
    item_category VARCHAR2(16) NOT NULL,
...
CREATE TABLE fac_tv_inspection_record (
    id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    record_kind VARCHAR2(16) NOT NULL,
    area_code VARCHAR2(32) NOT NULL,
    subject_name VARCHAR2(64) NOT NULL,
    badge VARCHAR2(32) NOT NULL,
    department VARCHAR2(64),
    gate_name VARCHAR2(64) NOT NULL,
    record_time VARCHAR2(32) NOT NULL,
    sort_no NUMBER(9) NOT NULL DEFAULT 0
);
