-- =============================================================================
-- V15 电视墙 —— 达梦 DM8 方言（Oracle 兼容，未实跑验证）
--   镜像自 h2/V15__tv.sql。本文件未经达梦实例实跑验证，按 DM8 语法编写，需上环境复核。
-- =============================================================================
...
CREATE TABLE fac_tv_operation_stat (
    ...
    event_total NUMBER(9) NOT NULL DEFAULT 0
);


CREATE TABLE fac_tv_inspection_record (
    id NUMBER(19) IDENTITY(1,1) PRIMARY KEY,
    record_kind VARCHAR2(16 CHAR) NOT NULL,
    area_code VARCHAR2(32 CHAR) NOT NULL,
    subject_name VARCHAR2(64 CHAR) NOT NULL,
    badge VARCHAR2(32 CHAR) NOT NULL,
    department VARCHAR2(64 CHAR),
    gate_name VARCHAR2(64 CHAR) NOT NULL,
    record_time VARCHAR2(32 CHAR) NOT NULL,
    sort_no NUMBER(9) NOT NULL DEFAULT 0
);
