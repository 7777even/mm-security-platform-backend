...
CREATE TABLE fac_rescue_equipment (
    ...
    equip_name VARCHAR2(64 CHAR) NOT NULL,
    squadron VARCHAR2(32 CHAR) NOT NULL,
    ...
    equip_model VARCHAR2(128 CHAR) NOT NULL,
    protection_type VARCHAR2(128 CHAR),
    filter_canister VARCHAR2(64 CHAR),
    max_continuous_use VARCHAR2(64 CHAR),
    storage_location VARCHAR2(128 CHAR),
    purchase_batch VARCHAR2(64 CHAR),
    factory_validity_years VARCHAR2(32 CHAR),
    remaining_validity VARCHAR2(32 CHAR),
    last_inspection_date VARCHAR2(32 CHAR),
    next_mandatory_maintenance_date VARCHAR2(32 CHAR),
    equipment_status VARCHAR2(32 CHAR),
    scrap_warning VARCHAR2(32 CHAR),
    issue_registration VARCHAR2(128 CHAR),
    spare_parts VARCHAR2(128 CHAR),
...
CREATE TABLE fac_rescue_personnel (
    ...
    squadron VARCHAR2(32 CHAR) NOT NULL,
    person_role VARCHAR2(32 CHAR) NOT NULL,
    sort_no NUMBER(9) NOT NULL DEFAULT 0
);
...
CREATE TABLE fac_rescue_option (
    id NUMBER(19) IDENTITY(1,1) PRIMARY KEY,
    option_kind VARCHAR2(32 CHAR) NOT NULL,
...
CREATE TABLE fac_rescue_vehicle (
    id NUMBER(19) IDENTITY(1,1) PRIMARY KEY,
    plate VARCHAR2(32 CHAR) NOT NULL,
    vehicle_type VARCHAR2(32 CHAR) NOT NULL,
    squadron VARCHAR2(32 CHAR) NOT NULL,
    leader_name VARCHAR2(32 CHAR) NOT NULL,
    leader_phone VARCHAR2(32 CHAR) NOT NULL,
    vehicle_status VARCHAR2(16 CHAR) NOT NULL,
    business_name VARCHAR2(64 CHAR) NOT NULL,
    vehicle_type_full VARCHAR2(64 CHAR) NOT NULL,
    parking_location VARCHAR2(128 CHAR),
    chassis_model VARCHAR2(64 CHAR),
    manufacture_date VARCHAR2(32 CHAR),
    inspection_expiry VARCHAR2(32 CHAR),
    foam_tank_volume VARCHAR2(32 CHAR),
    water_tank_volume VARCHAR2(32 CHAR),
    max_water_flow VARCHAR2(32 CHAR),
    foam_type VARCHAR2(32 CHAR),
    last_maintenance_date VARCHAR2(32 CHAR),
    next_maintenance_date VARCHAR2(32 CHAR),
    total_mileage VARCHAR2(32 CHAR),
    fault_record VARCHAR2(128 CHAR),
    inspection_status VARCHAR2(32 CHAR),
    sort_no NUMBER(9) NOT NULL DEFAULT 0
);
...
CREATE TABLE fac_rescue_vehicle_crew (
    ...
    member_role VARCHAR2(32 CHAR) NOT NULL,
    member_name VARCHAR2(32 CHAR) NOT NULL,
    phone VARCHAR2(32 CHAR) NOT NULL,
    certificate VARCHAR2(128 CHAR),
    duty_status VARCHAR2(32 CHAR),
    sort_no NUMBER(9) NOT NULL DEFAULT 0
);
...
CREATE TABLE fac_rescue_vehicle_equipment (
    ...
    vehicle_id NUMBER(19) NOT NULL,
    equip_name VARCHAR2(64 CHAR) NOT NULL,
    quantity VARCHAR2(32 CHAR) NOT NULL,
    equip_model VARCHAR2(64 CHAR),
    next_check_date VARCHAR2(32 CHAR),
    equipment_status VARCHAR2(32 CHAR),
    storage_location VARCHAR2(128 CHAR),
    sort_no NUMBER(9) NOT NULL DEFAULT 0
);
...
CREATE TABLE fac_rescue_vehicle_kv (
    id NUMBER(19) IDENTITY(1,1) PRIMARY KEY,
    vehicle_id NUMBER(19) NOT NULL,
    kv_kind VARCHAR2(32 CHAR) NOT NULL,
    kv_label VARCHAR2(64 CHAR) NOT NULL,
    value_text VARCHAR2(128 CHAR) NOT NULL,
    sort_no NUMBER(9) NOT NULL DEFAULT 0
);
...
CREATE TABLE fac_brigade_team (
    id NUMBER(19) IDENTITY(1,1) PRIMARY KEY,
    team_name VARCHAR2(64 CHAR) NOT NULL,
    area VARCHAR2(32 CHAR) NOT NULL,
...
CREATE TABLE fac_brigade_vehicle (
    ...
    vehicle_type VARCHAR2(32 CHAR) NOT NULL,
    vehicle_status VARCHAR2(16 CHAR) NOT NULL,
    parking_location VARCHAR2(64 CHAR),
    sort_no NUMBER(9) NOT NULL DEFAULT 0
);
...
CREATE TABLE fac_brigade_person (
    ...
    person_name VARCHAR2(32 CHAR) NOT NULL,
    person_role VARCHAR2(32 CHAR) NOT NULL,
    person_group VARCHAR2(32 CHAR) NOT NULL,
    phone VARCHAR2(32 CHAR) NOT NULL,
    duty_status VARCHAR2(16 CHAR) NOT NULL,
    sort_no NUMBER(9) NOT NULL DEFAULT 0
);
...
CREATE TABLE fac_brigade_equipment (
    ...
    equip_status VARCHAR2(16 CHAR),
    storage_location VARCHAR2(64 CHAR),
    sort_no NUMBER(9) NOT NULL DEFAULT 0
);
...
SET IDENTITY_INSERT fac_rescue_equipment ON;
...
SET IDENTITY_INSERT fac_rescue_equipment OFF;
SET IDENTITY_INSERT fac_rescue_personnel ON;
...
SET IDENTITY_INSERT fac_rescue_personnel OFF;
SET IDENTITY_INSERT fac_rescue_vehicle ON;
...
SET IDENTITY_INSERT fac_rescue_vehicle OFF;
...
SET IDENTITY_INSERT fac_brigade_team ON;
...
SET IDENTITY_INSERT fac_brigade_team OFF;
