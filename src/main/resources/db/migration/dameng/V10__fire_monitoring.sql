...
CREATE TABLE fac_rescue_force_stat (
    ...
    icon_type VARCHAR2(32 CHAR) NOT NULL,
...
CREATE TABLE fac_fire_patrol (
    ...
    shift_name VARCHAR2(16 CHAR) NOT NULL,
    duty_person VARCHAR2(32 CHAR) NOT NULL,
    patrol_count VARCHAR2(16 CHAR) NOT NULL,
    locations VARCHAR2(255 CHAR) NOT NULL,
...
CREATE TABLE fac_fire_patrol_item_def (
    id NUMBER(19) IDENTITY(1,1) PRIMARY KEY,
    item_code VARCHAR2(8 CHAR) NOT NULL,
    category VARCHAR2(32 CHAR) NOT NULL,
    content VARCHAR2(128 CHAR) NOT NULL,
    sort_no NUMBER(9) NOT NULL DEFAULT 0
);
...
CREATE TABLE fac_fire_patrol_item_result (
    ...
    item_code VARCHAR2(8 CHAR) NOT NULL,
    check_result VARCHAR2(16 CHAR) NOT NULL,
    abnormal_desc VARCHAR2(255 CHAR),
    photo_file VARCHAR2(128 CHAR)
);
