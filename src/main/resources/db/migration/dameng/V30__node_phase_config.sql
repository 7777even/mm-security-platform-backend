...
CREATE TABLE fac_node_phase_config (
    ...
    node_id VARCHAR2(32 CHAR) NOT NULL,
    node_name VARCHAR2(64 CHAR) NOT NULL,
    camera_anchors VARCHAR2(256 CHAR) NOT NULL DEFAULT '',
    custom_center VARCHAR2(64 CHAR),
    buffer_radius_meters NUMBER(9) NOT NULL DEFAULT 260,
    right_hidden_tabs VARCHAR2(256 CHAR) NOT NULL DEFAULT '',
    left_hidden_panels VARCHAR2(256 CHAR) NOT NULL DEFAULT '',
