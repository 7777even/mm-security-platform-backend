...
ALTER TABLE fac_vehicle_search ADD vehicle_type VARCHAR2(32);

ALTER TABLE fac_vehicle_search ADD driver_name VARCHAR2(32);

ALTER TABLE fac_vehicle_search ADD driver_phone VARCHAR2(32);

ALTER TABLE fac_vehicle_search ADD company VARCHAR2(64);

ALTER TABLE fac_vehicle_search ADD appointment_no VARCHAR2(32);

ALTER TABLE fac_vehicle_search ADD appointment_time VARCHAR2(64);

ALTER TABLE fac_vehicle_search ADD visit_purpose VARCHAR2(64);

ALTER TABLE fac_vehicle_search ADD waybill_no VARCHAR2(32);

ALTER TABLE fac_vehicle_search ADD cargo VARCHAR2(64);

ALTER TABLE fac_vehicle_search ADD destination VARCHAR2(64);


-- 2) 人员检索详情扩展列（原 securitySearchMock.personDetailExtras 迁入 DB）
ALTER TABLE fac_person_search ADD gender VARCHAR2(8);

ALTER TABLE fac_person_search ADD phone VARCHAR2(32);

ALTER TABLE fac_person_search ADD company VARCHAR2(64);

ALTER TABLE fac_person_search ADD id_number VARCHAR2(32);

ALTER TABLE fac_person_search ADD appointment_no VARCHAR2(32);

ALTER TABLE fac_person_search ADD appointment_time VARCHAR2(64);

ALTER TABLE fac_person_search ADD visit_purpose VARCHAR2(64);

ALTER TABLE fac_person_search ADD special_operation VARCHAR2(64);

ALTER TABLE fac_person_search ADD operation_area VARCHAR2(64);


-- 3) 轨迹时间轴表（entity_id 为 NULL 的行表示该模式下的默认轨迹）
CREATE TABLE fac_security_track (
    id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    track_mode VARCHAR2(16) NOT NULL,
    entity_id NUMBER(19) NULL,
    seq_no NUMBER(9) NOT NULL,
    location VARCHAR2(64),
    status VARCHAR2(32),
    status_tone VARCHAR2(16),
    track_time VARCHAR2(32),
    capture_hint VARCHAR2(64)
);


-- 4) 轨迹模式配置表（起止点标签）
CREATE TABLE fac_security_track_meta (
    track_mode VARCHAR2(16) PRIMARY KEY,
    start_label VARCHAR2(32),
    end_label VARCHAR2(32)
);
