-- =============================================================================
-- V3 重大危险源/监测设施域（建表+种子） —— 达梦 DM8 方言（Oracle 兼容，未实跑验证）
--   镜像自 h2/V3__hazard_monitoring_facility.sql。本文件未经达梦实例实跑验证，按 DM8 语法编写，需上环境复核。
-- =============================================================================
