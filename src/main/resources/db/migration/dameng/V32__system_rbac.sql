...
CREATE TABLE sys_role (
    ...
    data_scope   VARCHAR2(16 CHAR)  DEFAULT 'SELF' NOT NULL,
...
CREATE TABLE sys_dict_type (
    ...
    dict_name    VARCHAR2(64 CHAR)  NOT NULL,
    description  VARCHAR2(255 CHAR),
    status       NUMBER(3)     DEFAULT 1 NOT NULL,
    built_in     NUMBER(3)     DEFAULT 0 NOT NULL,
    deleted      NUMBER(3)     DEFAULT 0 NOT NULL,
...
CREATE TABLE sys_dict_item (
    ...
    item_label   VARCHAR2(128 CHAR) NOT NULL,
    sort_order   NUMBER(9)     DEFAULT 0 NOT NULL,
    status       NUMBER(3)     DEFAULT 1 NOT NULL,
    description  VARCHAR2(255 CHAR),
    deleted      NUMBER(3)     DEFAULT 0 NOT NULL,
...
ALTER TABLE sys_menu ADD menu_type VARCHAR2(16 CHAR) DEFAULT 'MENU' NOT NULL;
ALTER TABLE sys_menu ADD perm_code VARCHAR2(128 CHAR);
