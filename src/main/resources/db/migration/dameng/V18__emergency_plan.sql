-- =============================================================================
-- V18 应急预案 —— 达梦 DM8 方言（Oracle 兼容，未实跑验证）
--   镜像自 h2/V18__emergency_plan.sql。本文件未经达梦实例实跑验证，按 DM8 语法编写，需上环境复核。
-- =============================================================================
...
CREATE TABLE fac_emergency_plan (
    ...
    tab_key VARCHAR2(32 CHAR) NOT NULL,
    plan_name VARCHAR2(128 CHAR) NOT NULL,
    accident_type VARCHAR2(32 CHAR) NOT NULL,
    facility VARCHAR2(64 CHAR) NOT NULL,
...
CREATE TABLE fac_plan_major_phase (
    ...
    phase_name VARCHAR2(128 CHAR) NOT NULL,
    phase_order NUMBER(9) NOT NULL DEFAULT 0,
    upgrade_process VARCHAR2(1024 CHAR)
);
...
CREATE TABLE fac_plan_sub_phase (
    ...
    instance_id NUMBER(19) NOT NULL,
    phase_code VARCHAR2(32 CHAR) NOT NULL,
    parent_code VARCHAR2(32 CHAR) NOT NULL,
    phase_name VARCHAR2(128 CHAR) NOT NULL,
    phase_order NUMBER(9) NOT NULL DEFAULT 0,
    progress NUMBER(9)
);
...
CREATE TABLE fac_plan_risk_event (
    id NUMBER(19) IDENTITY(1,1) PRIMARY KEY,
    instance_id NUMBER(19) NOT NULL,
    event_code VARCHAR2(32 CHAR) NOT NULL,
    sub_phase_code VARCHAR2(32 CHAR) NOT NULL,
...
CREATE TABLE fac_plan_resource (
    ...
    expected_count VARCHAR2(32 CHAR) NOT NULL,
    actual_count VARCHAR2(32 CHAR) NOT NULL,
    leader_name VARCHAR2(64 CHAR),
    contact_phone VARCHAR2(64 CHAR),
    duties VARCHAR2(1024 CHAR) NOT NULL,
...
CREATE TABLE fac_plan_action_card (
    id NUMBER(19) IDENTITY(1,1) PRIMARY KEY,
    instance_id NUMBER(19) NOT NULL,
    card_code VARCHAR2(32 CHAR) NOT NULL,
    resource_code VARCHAR2(32 CHAR) NOT NULL,
    title VARCHAR2(256 CHAR) NOT NULL,
    content_text VARCHAR2(512 CHAR),
    description_text VARCHAR2(512 CHAR),
    start_sub_phase_code VARCHAR2(32 CHAR) NOT NULL,
    end_sub_phase_code VARCHAR2(32 CHAR) NOT NULL,
    risk_event_code VARCHAR2(32 CHAR),
    card_status VARCHAR2(16 CHAR) NOT NULL,
...
INSERT INTO fac_emergency_plan (tab_key, plan_name, accident_type, facility, sort_no) VALUES ('disposal', '乙烯储罐火灾处置方案', '火灾/爆炸', '乙烯罐区', 1);
INSERT INTO fac_emergency_plan (tab_key, plan_name, accident_type, facility, sort_no) VALUES ('disposal', '液氨泄漏现场处置方案', '泄漏', '乙烯罐区', 2);
INSERT INTO fac_emergency_plan (tab_key, plan_name, accident_type, facility, sort_no) VALUES ('fire', '乙烯装置消防救援处置方案', '火灾/爆炸', '乙烯裂解装置', 3);
...
INSERT INTO fac_plan_instance (plan_code, title, description, sort_no) VALUES ('plan-t103-002', '加氢制氢部加氢裂化装置T103塔灭火救援预案',
...
INSERT INTO fac_plan_major_phase (instance_id, phase_code, phase_name, phase_order, upgrade_process) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-t103-002'), 'm3_1', '1、班组自救与出动侦察', 1,
   '全勤出动后，接警室与报警人联系了解信息。中队先期到达现场，马上联系工艺人员，30分钟内安排人员侦察、搜救、拉设警戒线并实施控制。若火势扩大或涉及有毒气体扩散，立即呼叫总指挥升级响应。');
INSERT INTO fac_plan_major_phase (instance_id, phase_code, phase_name, phase_order, upgrade_process) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-t103-002'), 'm3_2', '2、中队展开与泡沫主攻', 2,
...
INSERT INTO fac_plan_sub_phase (instance_id, phase_code, parent_code, phase_name, phase_order, progress) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-t103-002'), 'sp3_1_2', 'm3_1', '工艺联系与侦察搜救', 2, 100);
INSERT INTO fac_plan_sub_phase (instance_id, phase_code, parent_code, phase_name, phase_order, progress) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-t103-002'), 'sp3_2_1', 'm3_2', '辖区消防力量部署', 3, 85);
INSERT INTO fac_plan_sub_phase (instance_id, phase_code, parent_code, phase_name, phase_order, progress) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-t103-002'), 'sp3_2_2', 'm3_2', '泡沫主攻与流洒火扑灭', 4, 70);
INSERT INTO fac_plan_sub_phase (instance_id, phase_code, parent_code, phase_name, phase_order, progress) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-t103-002'), 'sp3_2_3', 'm3_2', '邻近装置降温隔离防护', 5, 60);
INSERT INTO fac_plan_sub_phase (instance_id, phase_code, parent_code, phase_name, phase_order, progress) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-t103-002'), 'sp3_3_1', 'm3_3', '配合工艺带火紧急关阀', 6, 25);
...
INSERT INTO fac_plan_resource (instance_id, resource_code, resource_name, expected_count, actual_count, leader_name, contact_phone, duties, longitude, latitude, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-t103-002'), 'res-t103-2', '气防中心专业侦察与突击搜救中队', '5', '5', NULL, NULL,
   '着全封闭重型防护服深入下风向与核心热区检测硫化氢与可燃烃类浓度，对高温浓烟区域实施失联人员与被困职工快速突击搜救。', 110.886, 21.6862, 2);
INSERT INTO fac_plan_resource (instance_id, resource_code, resource_name, expected_count, actual_count, leader_name, contact_phone, duties, longitude, latitude, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-t103-002'), 'res-t103-3', '专职消防中队重型泡沫扑救总攻突击队', '6', '6', NULL, NULL,
   '实施主流洒火扑灭压制总攻；布置多管泡沫管枪从上风向及侧上风向持续覆盖池火与管道泄漏火，防止复燃。', 110.8865, 21.685, 3);
INSERT INTO fac_plan_resource (instance_id, resource_code, resource_name, expected_count, actual_count, leader_name, contact_phone, duties, longitude, latitude, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-t103-002'), 'res-t103-4', '邻近核心装置高压水幕隔离防爆中队', '8', '8', NULL, NULL,
...
INSERT INTO fac_plan_action_card (instance_id, card_code, resource_code, title, content_text, description_text, start_sub_phase_code, end_sub_phase_code, risk_event_code, card_status, is_global, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-t103-002'), 'c-t103-101', 'res-t103-1', '成立火灾救援现场指挥部并联系工艺人员',
   '成立火灾救援现场指挥部，了解T103塔减压塔底介质参数。', NULL, 'sp3_1_1', 'sp3_1_2', NULL, 'completed', 0, 1);
INSERT INTO fac_plan_action_card (instance_id, card_code, resource_code, title, content_text, description_text, start_sub_phase_code, end_sub_phase_code, risk_event_code, card_status, is_global, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-t103-002'), 'c-t103-102', 'res-t103-2', '派员出动气防车进行毒气浓度侦检',
   '穿戴重型防护服在下风向检测烃类和二氧化硫气体，搜救失联人员。', NULL, 'sp3_1_1', 'sp3_1_2', NULL, 'completed', 0, 2);
INSERT INTO fac_plan_action_card (instance_id, card_code, resource_code, title, content_text, description_text, start_sub_phase_code, end_sub_phase_code, risk_event_code, card_status, is_global, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-t103-002'), 'c-t103-201', 'res-t103-2', '利用防爆热成像仪对T103塔底泄漏点定位',
   '对减压塔底泵及周围管段进行热成像测温，回传温度数据。', NULL, 'sp3_1_2', 'sp3_2_1', NULL, 'in-progress', 0, 3);
INSERT INTO fac_plan_action_card (instance_id, card_code, resource_code, title, content_text, description_text, start_sub_phase_code, end_sub_phase_code, risk_event_code, card_status, is_global, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-t103-002'), 'c-t103-202', 'res-t103-3', '部署泡沫主战消防车喷射泡沫扑灭地表流洒火',
   '调动主战泡沫消防车，利用车载泡沫炮大流量喷射扑灭地表流洒火。', NULL, 'sp3_2_1', 'sp3_2_2', 're3_1', 'in-progress', 0, 4);
INSERT INTO fac_plan_action_card (instance_id, card_code, resource_code, title, content_text, description_text, start_sub_phase_code, end_sub_phase_code, risk_event_code, card_status, is_global, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-t103-002'), 'c-t103-203', 'res-t103-4', '使用水炮对四催和柴油加氢邻近装置冷却',
   '设置高位移动水炮，持续对受辐射热严重的四催等邻近设备冷却。', NULL, 'sp3_2_2', 'sp3_2_3', NULL, 'in-progress', 0, 5);
INSERT INTO fac_plan_action_card (instance_id, card_code, resource_code, title, content_text, description_text, start_sub_phase_code, end_sub_phase_code, risk_event_code, card_status, is_global, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-t103-002'), 'c-t103-301', 'res-t103-5', '配合工艺人员利用防护屏板掩护，紧急带火关阀',
   '消防突击队穿隔热服，手持喷淋水幕掩护车间工艺工关闭紧急泄放阀。', NULL, 'sp3_3_1', 'sp3_3_1', 're3_2', 'pending', 0, 6);
INSERT INTO fac_plan_action_card (instance_id, card_code, resource_code, title, content_text, description_text, start_sub_phase_code, end_sub_phase_code, risk_event_code, card_status, is_global, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-t103-002'), 'c-t103-302', 'res-t103-3', '调集后方泡沫运输车增援，源源不断输送泡沫液',
   '保障室调用3台大型泡沫罐车，往火场核心持续供给高效泡沫混合液。', NULL, 'sp3_3_2', 'sp3_3_3', NULL, 'pending', 1, 7);
...
INSERT INTO fac_plan_major_phase (instance_id, phase_code, phase_name, phase_order, upgrade_process) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-flood-003'), 'm4_1', '1、预备值守与防汛动员', 1,
   '中心及各中队启动领导带班值守，30分钟内备齐防汛排涝应急物资（照明灯、抽水机、通信器材、救生衣等），并完成车辆排涝泵保养；若降雨量突破50mm且有积水趋势，启动Ⅱ级响应。');
INSERT INTO fac_plan_major_phase (instance_id, phase_code, phase_name, phase_order, upgrade_process) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-flood-003'), 'm4_2', '2、厂区防汛与初期排涝', 2,
...
INSERT INTO fac_plan_sub_phase (instance_id, phase_code, parent_code, phase_name, phase_order, progress) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-flood-003'), 'sp4_1_2', 'm4_1', '防排涝装备检查维护', 2, 100);
INSERT INTO fac_plan_sub_phase (instance_id, phase_code, parent_code, phase_name, phase_order, progress) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-flood-003'), 'sp4_2_1', 'm4_2', '6#/9#/11#路挡水板安装', 3, 90);
INSERT INTO fac_plan_sub_phase (instance_id, phase_code, parent_code, phase_name, phase_order, progress) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-flood-003'), 'sp4_2_2', 'm4_2', '各中队排水防线预置', 4, 80);
INSERT INTO fac_plan_sub_phase (instance_id, phase_code, parent_code, phase_name, phase_order, progress) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-flood-003'), 'sp4_3_1', 'm4_3', '龙吸水排涝车部署强排', 5, 60);
...
INSERT INTO fac_plan_resource (instance_id, resource_code, resource_name, expected_count, actual_count, leader_name, contact_phone, duties, longitude, latitude, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-flood-003'), 'res-flood-2', '装备保障物资组', '8', '8', NULL, NULL,
   '准备防汛排涝应急物资如照明灯、抽水泵、通信器材、救生衣等。', NULL, NULL, 2);
INSERT INTO fac_plan_resource (instance_id, resource_code, resource_name, expected_count, actual_count, leader_name, contact_phone, duties, longitude, latitude, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-flood-003'), 'res-flood-3', '安全监督防灾室', '4', '4', NULL, NULL,
   '负责各中队排涝抢险的风险评估识别及现场过程安全监控。', NULL, NULL, 3);
INSERT INTO fac_plan_resource (instance_id, resource_code, resource_name, expected_count, actual_count, leader_name, contact_phone, duties, longitude, latitude, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-flood-003'), 'res-flood-4', '乙烯中队（化工厂区）', '15', '15', NULL, NULL,
...
INSERT INTO fac_plan_action_card (instance_id, card_code, resource_code, title, content_text, description_text, start_sub_phase_code, end_sub_phase_code, risk_event_code, card_status, is_global, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-flood-003'), 'c-flood-101', 'res-flood-1', '机关室分为化工组与炼油组，分头执勤值守',
   '中心领导、中队领导启动带班制。机关分成化工组和炼油组分别下沉现场指导。', NULL, 'sp4_1_1', 'sp4_1_1', NULL, 'completed', 0, 1);
INSERT INTO fac_plan_action_card (instance_id, card_code, resource_code, title, content_text, description_text, start_sub_phase_code, end_sub_phase_code, risk_event_code, card_status, is_global, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-flood-003'), 'c-flood-102', 'res-flood-2', '清点并分发防汛排涝应急物资与通信器材',
   '准备并调配照明灯、防寒劳保、移动抽水泵、穿式救生衣和移动充电设备。', NULL, 'sp4_1_1', 'sp4_1_2', NULL, 'completed', 0, 2);
INSERT INTO fac_plan_action_card (instance_id, card_code, resource_code, title, content_text, description_text, start_sub_phase_code, end_sub_phase_code, risk_event_code, card_status, is_global, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-flood-003'), 'c-flood-201', 'res-flood-5', '在6#路与9#路、11#路交界处及各门岗安装挡水板',
   '炼油中队部署消防力量，迅速在关键路口交界及门岗处搭设防汛挡水防线。', NULL, 'sp4_2_1', 'sp4_2_1', NULL, 'completed', 0, 3);
INSERT INTO fac_plan_action_card (instance_id, card_code, resource_code, title, content_text, description_text, start_sub_phase_code, end_sub_phase_code, risk_event_code, card_status, is_global, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-flood-003'), 'c-flood-202', 'res-flood-3', '对4号排洪沟和导流沟垃圾浮余进行清理',
   '指战员清理排洪明沟，防止树枝泥沙淤积导致的排水不畅。', NULL, 'sp4_2_1', 'sp4_2_2', 're4_1', 'completed', 0, 4);
INSERT INTO fac_plan_action_card (instance_id, card_code, resource_code, title, content_text, description_text, start_sub_phase_code, end_sub_phase_code, risk_event_code, card_status, is_global, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-flood-003'), 'c-flood-301', 'res-flood-6', '在高碳雨污池部署龙吸水排涝车强力排水',
   '将龙吸水排涝车停驻在高碳装置区，架设强排管线满负荷抽水。', NULL, 'sp4_3_1', 'sp4_3_1', NULL, 'in-progress', 0, 5);
INSERT INTO fac_plan_action_card (instance_id, card_code, resource_code, title, content_text, description_text, start_sub_phase_code, end_sub_phase_code, risk_event_code, card_status, is_global, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-flood-003'), 'c-flood-302', 'res-flood-4', '新鲜水泵房区域部署大水牛排涝机器人',
   '使用特勤大水牛机器人，进入泵房低洼深水积水处，启动智能高位排水。', NULL, 'sp4_3_2', 'sp4_3_2', 're4_2', 'in-progress', 0, 6);
INSERT INTO fac_plan_action_card (instance_id, card_code, resource_code, title, content_text, description_text, start_sub_phase_code, end_sub_phase_code, risk_event_code, card_status, is_global, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-flood-003'), 'c-flood-303', 'res-flood-5', '6#路地磅北地沟积水强排至301事故池',
   '炼油中队启动大功率抽水车将地磅北地沟积水引入301事故暂存池。', NULL, 'sp4_3_2', 'sp4_3_3', 're4_3', 'in-progress', 0, 7);
...
INSERT INTO fac_plan_major_phase (instance_id, phase_code, phase_name, phase_order, upgrade_process) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-maoming-001'), 'm1', '1、Ⅲ级响应（车间自救）', 1,
   '当班班组/巡检员发现异常立即报告控制室主操；由当班班长上报至车间安全员与车间主任，15分钟内上报分部调度室。若事故在车间内未能控制或涉及易燃易爆、毒气外泄，即刻启动升级程序。');
INSERT INTO fac_plan_major_phase (instance_id, phase_code, phase_name, phase_order, upgrade_process) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-maoming-001'), 'm2', '2、Ⅱ级响应（分部级处置）', 2,
...
INSERT INTO fac_plan_sub_phase (instance_id, phase_code, parent_code, phase_name, phase_order, progress) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-maoming-001'), 'sp1_2', 'm1', '初期自救与工艺切断', 2, 100);
INSERT INTO fac_plan_sub_phase (instance_id, phase_code, parent_code, phase_name, phase_order, progress) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-maoming-001'), 'sp1_3', 'm1', '雨水排口关闭与围堵', 3, 100);
INSERT INTO fac_plan_sub_phase (instance_id, phase_code, parent_code, phase_name, phase_order, progress) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-maoming-001'), 'sp2_1', 'm2', '分部现场指挥部成立', 4, 80);
INSERT INTO fac_plan_sub_phase (instance_id, phase_code, parent_code, phase_name, phase_order, progress) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-maoming-001'), 'sp2_2', 'm2', '工艺倒罐与SDS紧急停车', 5, 60);
INSERT INTO fac_plan_sub_phase (instance_id, phase_code, parent_code, phase_name, phase_order, progress) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-maoming-001'), 'sp3_1', 'm3', '政企联动与政府预案请求', 6, 20);
...
INSERT INTO fac_plan_resource (instance_id, resource_code, resource_name, expected_count, actual_count, leader_name, contact_phone, duties, longitude, latitude, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-maoming-001'), 'res-2', '公司应急调度指挥与综合通报组', '8', '8',
   '王立新（办公室主任）', '0668-2288301（调度专线 8002）',
   '常驻应急调度中心；传达总指挥各项战斗指令；统辖全厂公用工程（水、电、蒸汽、风）联锁切断与供应；负责上下级政企信息不间断直报。', 110.8845, 21.6868, 2);
INSERT INTO fac_plan_resource (instance_id, resource_code, resource_name, expected_count, actual_count, leader_name, contact_phone, duties, longitude, latitude, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-maoming-001'), 'res-3', '企业专职消防一中队与港区气防中队', '40', '40',
   '李胜利（特勤大队长）', '139-0251-1119（对讲频道 Ch-1）',
   '实施重度热区警戒与被困人员突击搜救；展开360°水幕喷淋降温防爆；铺设高倍数抗溶泡沫覆盖罐区液面隔绝空气。', 110.8872, 21.6853, 3);
INSERT INTO fac_plan_resource (instance_id, resource_code, resource_name, expected_count, actual_count, leader_name, contact_phone, duties, longitude, latitude, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-maoming-001'), 'res-4', '化工车间工艺控制与自救应急班组', '18', '18',
...
INSERT INTO fac_plan_action_card (instance_id, card_code, resource_code, title, content_text, description_text, start_sub_phase_code, end_sub_phase_code, risk_event_code, card_status, is_global, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-maoming-001'), 'c-env-101', 'res-4', '当班班组确认异常并执行工艺紧急切断',
   '控制室主操确认DCS/SIS报警，执行火炬放空、隔离泄漏源与安全停车。', NULL, 'sp1_1', 'sp1_2', 'r1', 'completed', 0, 1);
INSERT INTO fac_plan_action_card (instance_id, card_code, resource_code, title, content_text, description_text, start_sub_phase_code, end_sub_phase_code, risk_event_code, card_status, is_global, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-maoming-001'), 'c-env-102', 'res-4', '关闭雨水总排连通阀并围堵废水',
   '现场操作工就近关闭雨水总排连通阀，使用沙袋围堵泄漏废水。', NULL, 'sp1_2', 'sp1_3', 'r2', 'completed', 0, 2);
INSERT INTO fac_plan_action_card (instance_id, card_code, resource_code, title, content_text, description_text, start_sub_phase_code, end_sub_phase_code, risk_event_code, card_status, is_global, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-maoming-001'), 'c-env-201', 'res-1', '成立分部现场指挥部并通报地方政府',
   '分部指挥中心接管，总指挥下达处置方案，应急办公室向地方政府通报。', NULL, 'sp2_1', 'sp2_1', NULL, 'in-progress', 0, 3);
INSERT INTO fac_plan_action_card (instance_id, card_code, resource_code, title, content_text, description_text, start_sub_phase_code, end_sub_phase_code, risk_event_code, card_status, is_global, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-maoming-001'), 'c-env-202', 'res-2', '组织工艺倒罐与SDS紧急停车联动',
   '调度中心联动车间执行倒罐、SDS紧急停车，DCS联锁切料并持续监测。', NULL, 'sp2_2', 'sp2_2', 'r3', 'in-progress', 0, 4);
INSERT INTO fac_plan_action_card (instance_id, card_code, resource_code, title, content_text, description_text, start_sub_phase_code, end_sub_phase_code, risk_event_code, card_status, is_global, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-maoming-001'), 'c-env-301', 'res-1', '启动Ⅰ级响应并请求政企联动增援',
   '公司指挥中心接管，30分钟内向市政府及生态环境局提报初报并请求增援。', NULL, 'sp3_1', 'sp3_1', NULL, 'pending', 0, 5);
INSERT INTO fac_plan_action_card (instance_id, card_code, resource_code, title, content_text, description_text, start_sub_phase_code, end_sub_phase_code, risk_event_code, card_status, is_global, sort_no) VALUES ((SELECT id FROM fac_plan_instance WHERE plan_code = 'plan-maoming-001'), 'c-env-302', 'res-3', '泡沫洗消与水幕隔离总攻',
   '消防主力展开泡沫覆盖与水幕隔离，阻止有毒气体与火焰扩散。', NULL, 'sp3_2', 'sp3_2', NULL, 'pending', 0, 6);
