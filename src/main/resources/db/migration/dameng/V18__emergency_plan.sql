...
CREATE TABLE fac_plan_instance (
    id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    plan_code VARCHAR2(64) NOT NULL,
...
CREATE TABLE fac_plan_resource (
    ...
    expected_count VARCHAR2(32) NOT NULL,
    actual_count VARCHAR2(32) NOT NULL,
    leader_name VARCHAR2(64),
    contact_phone VARCHAR2(64),
    duties VARCHAR2(1024) NOT NULL,
...
CREATE TABLE fac_plan_action_card (
    ...
    resource_code VARCHAR2(32) NOT NULL,
    title VARCHAR2(256) NOT NULL,
    content_text VARCHAR2(512),
    description_text VARCHAR2(512),
    start_sub_phase_code VARCHAR2(32) NOT NULL,
    end_sub_phase_code VARCHAR2(32) NOT NULL,
    risk_event_code VARCHAR2(32),
