...
CREATE TABLE fac_blacklist_entry (
    ...
    entry_kind VARCHAR2(16) NOT NULL,
    subject_name VARCHAR2(64) NOT NULL,
    id_card VARCHAR2(32),
    reason_text VARCHAR2(128) NOT NULL,
...
CREATE TABLE fac_fire_situation_marker (
    id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    marker_code VARCHAR2(32) NOT NULL,
    marker_kind VARCHAR2(16) NOT NULL,
    title VARCHAR2(64) NOT NULL,
    subtitle VARCHAR2(128) NOT NULL,
    longitude DOUBLE PRECISION,
    latitude DOUBLE PRECISION,
    important_flag NUMBER(1) NOT NULL DEFAULT 0,
    icon_url VARCHAR2(128) NOT NULL,
