...
CREATE TABLE fac_comm_device (
    ...
    device_code VARCHAR2(32 CHAR) NOT NULL,
    device_type VARCHAR2(16 CHAR) NOT NULL,
    group_key VARCHAR2(32 CHAR) NOT NULL,
    group_label VARCHAR2(64 CHAR) NOT NULL,
    device_name VARCHAR2(64 CHAR) NOT NULL,
    area_name VARCHAR2(64 CHAR) NOT NULL,
    location_name VARCHAR2(64 CHAR) NOT NULL,
    device_status VARCHAR2(16 CHAR) NOT NULL,
    longitude DOUBLE PRECISION NOT NULL,
    latitude DOUBLE PRECISION NOT NULL,
    category_name VARCHAR2(64 CHAR) NOT NULL,
    install_time VARCHAR2(32 CHAR) NOT NULL,
    owner_name VARCHAR2(64 CHAR) NOT NULL,
    ip_address VARCHAR2(64 CHAR) NOT NULL,
    last_check_time VARCHAR2(32 CHAR) NOT NULL,
...
CREATE TABLE fac_weather_current (
    ...
    condition_text VARCHAR2(32 CHAR) NOT NULL,
    air_quality NUMBER(9) NOT NULL DEFAULT 0,
    air_quality_level VARCHAR2(16 CHAR) NOT NULL,
    wind_direction VARCHAR2(16 CHAR) NOT NULL,
    wind_speed VARCHAR2(16 CHAR) NOT NULL,
    wind_level VARCHAR2(16 CHAR) NOT NULL,
    humidity_text VARCHAR2(16 CHAR) NOT NULL,
    pressure_text VARCHAR2(16 CHAR) NOT NULL,
    visibility_text VARCHAR2(16 CHAR) NOT NULL,
    rainfall_text VARCHAR2(16 CHAR) NOT NULL,
...
CREATE TABLE fac_weather_hourly (
    id NUMBER(19) IDENTITY(1,1) PRIMARY KEY,
    time_label VARCHAR2(16 CHAR) NOT NULL,
...
CREATE TABLE fac_weather_daily (
    id NUMBER(19) IDENTITY(1,1) PRIMARY KEY,
    day_label VARCHAR2(16 CHAR) NOT NULL,
    date_label VARCHAR2(16 CHAR) NOT NULL,
    condition_text VARCHAR2(32 CHAR) NOT NULL,
    icon_text VARCHAR2(16 CHAR) NOT NULL,
    high_temp NUMBER(9) NOT NULL DEFAULT 0,
    low_temp NUMBER(9) NOT NULL DEFAULT 0,
    wind_text VARCHAR2(32 CHAR) NOT NULL,
    humidity_value NUMBER(9) NOT NULL DEFAULT 0,
    rain_value DOUBLE PRECISION NOT NULL DEFAULT 0,
    sort_no NUMBER(9) NOT NULL DEFAULT 0
);
