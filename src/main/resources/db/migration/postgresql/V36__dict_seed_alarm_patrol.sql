-- =============================================================================
-- V36 告警 / 巡检字典选项种子（PostgreSQL 方言）
--   与 h2/V36 同内容：把大屏「消防报警列表」筛选项与「防火巡查」班次/状态下拉，
--   从前端本地常量迁到后端字典，由 GET /api/v1/system/dicts/{dictCode} 提供
--   （登录可读、仅启用项、按 sort_order）。「全部X」哨兵由前端补，不入种子。
-- =============================================================================
