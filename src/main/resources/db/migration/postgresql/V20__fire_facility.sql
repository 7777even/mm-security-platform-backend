-- V20 消防设施监测大屏真实数据源（fm-fire-facility）。 —— PostgreSQL 方言（未实跑验证）
-- 镜像自 h2/V20。本文件未经 PostgreSQL 实例实跑验证，按标准 PG 语法编写，需上环境复核。
...
CREATE TABLE IF NOT EXISTS fac_fire_facility_monitor (
...
CREATE TABLE IF NOT EXISTS fac_fire_facility_param (
    id BIGSERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS fac_fire_facility_ledger (
    id BIGSERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS fac_fire_facility_maintenance (
    id BIGSERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS fac_fire_facility_fault (
    id BIGSERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS fac_fire_facility_fault_timeline (
    id BIGSERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS fac_fire_facility_option (
    id BIGSERIAL PRIMARY KEY,
