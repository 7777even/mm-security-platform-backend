-- =============================================================================
-- V35 大屏端剩余数据补接 —— PostgreSQL 方言（生产 profile）
--   与 H2 V35 对齐；BIGINT AUTO_INCREMENT -> BIGSERIAL，TINYINT -> SMALLINT。
--   说明：本文件未经 PG 实例实跑验证（本地无 PG 实例），需上环境复核。
...
-- 1) 派单人员名册
CREATE TABLE IF NOT EXISTS fac_dispatch_personnel (
...
CREATE TABLE IF NOT EXISTS fac_video_linkage_option (
    id           BIGSERIAL PRIMARY KEY,
