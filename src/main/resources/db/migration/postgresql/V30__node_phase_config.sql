-- V30 应急流程「节点联动配置」真实数据源（fm-accident-rescue 应急指挥 · 节点联动配置弹窗）。 —— PostgreSQL 方言（未实跑验证）
-- 镜像自 h2/V30。本文件未经 PostgreSQL 实例实跑验证，按标准 PG 语法编写，需上环境复核。
...
CREATE TABLE IF NOT EXISTS fac_node_phase_config (
