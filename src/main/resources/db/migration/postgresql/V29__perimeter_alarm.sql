-- V29 周界入侵告警（替代前端 SecurityStatusPanel 的 demo 常量 resolveDemoAlarmDetailById('demo-intrusion-1')）。 —— PostgreSQL 方言（未实跑验证）
-- 镜像自 h2/V29。本文件未经 PostgreSQL 实例实跑验证，按标准 PG 语法编写，需上环境复核。
...
CREATE TABLE IF NOT EXISTS fac_perimeter_alarm (
