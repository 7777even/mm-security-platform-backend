-- V21 安防黑名单 + 火情态势地图点位真实数据源。 —— PostgreSQL 方言（未实跑验证）
-- 镜像自 h2/V21。本文件未经 PostgreSQL 实例实跑验证，按标准 PG 语法编写，需上环境复核。
...
CREATE TABLE IF NOT EXISTS fac_blacklist_entry (
...
CREATE TABLE IF NOT EXISTS fac_fire_situation_marker (
    id BIGSERIAL PRIMARY KEY,
