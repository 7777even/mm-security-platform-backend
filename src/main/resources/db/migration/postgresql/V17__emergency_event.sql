-- V17 应急事件大屏真实数据源（应急指挥 / 先期处置 / 疏散人员）。 —— PostgreSQL 方言（未实跑验证）
-- 镜像自 h2/V17。本文件未经 PostgreSQL 实例实跑验证，按标准 PG 语法编写，需上环境复核。
...
CREATE TABLE IF NOT EXISTS fac_emergency_event (
...
CREATE TABLE IF NOT EXISTS fac_evacuation_person (
    id BIGSERIAL PRIMARY KEY,
