...
ALTER TABLE fac_rescue_personnel ADD COLUMN person_group VARCHAR(16);
ALTER TABLE fac_rescue_personnel ADD COLUMN phone VARCHAR(32);
ALTER TABLE fac_rescue_personnel ADD COLUMN duty_status VARCHAR(16);
ALTER TABLE fac_rescue_equipment ADD COLUMN category VARCHAR(32);
ALTER TABLE fac_rescue_equipment ADD COLUMN unit VARCHAR(16);
