-- =============================================================================
-- V70 周界入侵告警处置按钮级权限码种子（H2 方言）
--   1) 在 fm-security 下登记按钮级菜单 security:perimeter-ack（前端处置弹窗使用）
--   2) 授权 ADMIN 及五类岗位角色（对齐 V68 中 fire-facility:handle / V33 中 fire-alarm:ack 的授权口径）
