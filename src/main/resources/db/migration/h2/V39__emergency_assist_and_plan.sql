-- =============================================================================
-- V39 应急域数据源（H2方言）—— 大屏「前端数据全后端化」P0
--   目的：把 EmergencyAssistPanel 的 4 项辅助统计 + EmergencyPlanPanel 的预案目录
--         （4 行）与详情（5 段字段）迁到后端，由 GET /api/v1/emergency/assist-stats
--         与 /api/v1/emergency-plans/catalog 提供。
...
CREATE TABLE fac_emergency_plan_catalog (
    ...
    can_switch TINYINT NOT NULL DEFAULT 0,
