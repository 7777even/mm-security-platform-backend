-- =============================================================================
-- V38 消防态势大屏数据源（H2方言）—— 大屏「前端数据全后端化」P0
--   目的：把 SafetyAlarmPanel 的 14 个装置区 + FireMonitoredObjectsPanel 的 4 个重点监控对象
--         迁到后端，由 GET /api/v1/fire-situation/areas 与 /monitored-objects 提供。
