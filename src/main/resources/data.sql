...
-- 告警种子数据：替代原 AlarmController 的 devFallbackList 模拟数据，使空库联调也能看到真实报警列表。
-- status 为后端 int 语义（0=活动/1=已确认/2=已派发/3=已闭环），与前端 AlarmItem.status(string 枚举) 的映射属契约对齐债。
INSERT INTO fac_alarm (device_code, level, type, title, content, status, occurred_at) VALUES
('FAC2026FIREA00000001', 2, 'FIRE',  '罐区A消防探头-F01 温度越限', '感温探测器触发，温度超阈值', 0, '2026-09-01 08:12:00'),
('FAC2026GASA00000001',  3, 'GAS',  '装置C气体检测仪-G01 泄漏',   '可燃气浓度超二级报警',   1, '2026-09-02 14:30:00'),
('FAC2026FLOOD00000001', 1, 'FLOOD','危化仓库液位监测-L01 高液位', '储罐液位达 95% 上限',    0, '2026-09-03 21:05:00'),
('FAC2026CCTVA00000001', 2, 'CCTV', '罐区B监控-C01 画面丢失',      '视频流中断超过 60s',     2, '2026-09-04 09:48:00'),
('FAC2026FIREB00000001', 4, 'FIRE', '装置C消防探头-F03 误报',      '现场复核为误报',         3, '2026-09-05 11:20:00'),
('FAC2026GASB00000001',  2, 'GAS',  '装卸区气体检测仪-G02 报警',   '装卸臂接口疑似泄漏',     1, '2026-09-06 16:42:00'),
(NULL,                    3, 'SOS',  '现场应急呼叫',               '巡检人员触发 SOS 按钮',  0, '2026-09-07 07:15:00'),
(NULL,                    2, 'TEMP', '装置C温度异常',              '反应器温度梯度异常',     0, '2026-09-07 08:30:00');
