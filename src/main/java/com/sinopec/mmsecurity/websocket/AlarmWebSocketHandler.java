 ...
 *   - 服务端模拟：每 8s 推送一条模拟告警（实际替换为基于 fac_alarm 的增量推送即可）
 *
...
public class AlarmWebSocketHandler extends TextWebSocketHandler {
    ...
    /** 广播告警消息到所有已连接会话 */
    public void broadcastAlarm(Object alarmPayload) {
        try {
            String json = om.writeValueAsString(Map.of("type", "alarm", "data", alarmPayload));
